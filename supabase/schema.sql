...
-- Clientes de la agencia (dueños de campañas)
...
-- Campañas configurables (landing + reglas de números)
create table if not exists campaigns (
  ...
  -- Config de números estilo Lotería Nacional (Sorteo Mayor: 00001-60000)
...
-- Pool de números de rifa (pregenerados o bajo demanda)
...
-- Propuestas comerciales generadas según interés del lead
...
-- Solicitudes de nuevos clientes de la agencia (contenido / rifas)
...
-- Admin users para autenticación real con Supabase Auth
...
-- Semilla: campaña Rifas de Viajes (moldeable)
